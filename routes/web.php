...
function(){
    ...
    // My Order
    Route::get('accept/oder/{id}', [MyOrderController::class, 'accept'])->name('accept.order');
    Route::get('reject/oder/{id}', [MyOrderController::class, 'reject'])->name('reject.order');
    Route::resource('order', MyOrderController::class);

    // Profile
    Route::get('delete_photo', [ProfileController::class, 'delete'])->name('delete.profile');
