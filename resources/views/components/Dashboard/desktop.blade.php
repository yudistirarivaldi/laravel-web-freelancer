    ...
    <div class="text-serv-bg">
        ...
        <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
            ...
            {{-- <img class="object-cover object-center mr-1 rounded-full w-14 h-14"
             ...
             @if (auth()->user()->detail_user()->first()->photo != NULL)
                <img src="{{ url(Storage::url(auth()->user()->detail_user()->first()->photo)) }}" alt="photo profile" class="object-cover object-center mr-1 rounded-full w-14 h-14">
             @else
                <span class="inline ml-3 h-12 rounded-full text-gray-300">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                {{-- Span ini adalah penanda active --}}
