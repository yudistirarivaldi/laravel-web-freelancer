            ...
            <div class="m-auto text-center h-auto">
                <svg class="mb-6 w-full" width="490" height="350" viewBox="0 0 490 350" fill="none"
                    ...
                    <defs>
                        ...
                        <!-- Gambar kiri -->
                        <image id="image0" width="500" height="500" xlink:href="{{ url('https://randomuser.me/api/portraits/men/40.jpg') }}"/>
                        <!-- Gambar kanan -->
                        <image id="image1" width="500" height="500" xlink:href="{{ url('https://randomuser.me/api/portraits/men/97.jpg') }}"/>
                    </defs>
                </svg>
