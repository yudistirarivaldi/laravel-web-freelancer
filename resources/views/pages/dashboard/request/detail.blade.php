                                                ...
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                         ...
                                                         @if ($order->user_freelancer->detail_user->photo != NULL)
                                                            <img class="object-cover w-full h-full rounded-full" src="{{ url(url(Storage::url($order->user_freelancer->detail_user->photo))) }}" alt="photo freelancer" loading="lazy" />
                                                        @else
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-400">{{ $order->user_freelancer->role ?? '' }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                ...
                                <div class="flex p-8 border border-gray-200 rounded-lg bg-serv-upload-bg h-128">
                                    <div class="m-auto text-center">
                                        ...
                                        <div class="relative mt-0 md:mt-6">
                                            ...
                                            @if (isset($order->file))
                                                <a href="{{ url(Storage::url($order->file ?? '')) }}" class="px-4 py-2 mt-2 text-left text-gray-700 rounded-xl bg-serv-hr" onclick="return confirm('Are you sure want to download this file ?')">Donwload File</a>
                                            @else
                                                File not available
                                            @endif
