                ...
                <form action="{{ route('member.profile.update', [Auth::user()->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6">
                                    <div class="flex items-center mt-1">
                                        {{-- != NULL artinya jika foto tidak null --}}
                                        ...
                                        <a href="{{ route('member.delete.profile') }}" type="button" class="px-3 py-2 ml-5 text-sm font-medium leading-4 text-red-700 bg-transparent rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" onclick="return confirm('Are you sure want to delete your photo?')">
                                            Delete
                                        </a>
                                    </div>

                                    @if ($errors->has('photo'))
                                    <p class="text-red-500 mb-3 text-sm">{{ $erorrs->first('photo') }}</p>
                                    @endif
                                ...
                                <div class="md:col-span-6 lg:col-span-3">
                                    ...
                                    <input placeholder="Your Email" type="text" name="email" id="email" autocomplete="service-name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $user->email ?? '' }}" required>

                                    @if($errors->has('email'))
                                    <p class="text-red-500 mb-3 text-sm">{{ $errrors->first('email') }}</p>
                                    @endif
                                ...
                                <div class="md:col-span-6 lg:col-span-3">
                                    ...
                                    <p class="text-red-500 mb-3 text-sm">{{ $errrors->first('contact_number') }}</p>
                                    @endif
                                ...
                                <div class="col-span-6">
                                    ...
                                    <p class="text-red-500 mb-3 text-sm">{{ $errrors->first('biography') }}</p>
                                    @endif
                                ...
                                <div class="col-span-6">
                                    ...
                                    <p class="text-red-500 mb-3 text-sm">{{ $errrors->first('experience') }}</p>
                                    @endif
                        ...
                        <div class="px-4 py-3 text-right sm:px-6">
                            ...
                            <a href="{{ route('member.dashboard.index') }}" type="button" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300" onclick="return confirm('Are you sure want to cancel?, Any changes your make will not be saved.')">
                                Cancel
                            </a>
