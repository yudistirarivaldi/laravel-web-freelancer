                                            ...
                                            <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                                                ...
                                                <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                                                    <div class="flex mt-2 flex-nowrap">
                                                        ...
                                                        @click="changeThumbnail('{{ url(Storage::url($item->thumbnail)) }}', {{ $item->id }})" src="{{ url(Storage::url($item->thumbnail)) }}" alt="thumbnail service" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
