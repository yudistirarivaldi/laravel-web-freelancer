        ...
        <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
            <div class="col-span-8">
                ...
                <p class="text-sm text-gray-400">
                    {{-- order_freelancer didapat dari model user --}}
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr class="text-gray-700 border-b">
                                    ...
                                    <div class="flex items-center text-sm">
                                        <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                            ...
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="{{ url(url(Storage::url($item->user_buyer->detail_user->photo))) }}"
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">{{ $item->user_buyer->detail_user->role ??
                                                '' }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="w-2/6 px-1 py-5">
                                    <div class="flex items-center text-sm">
                                        <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                            ...
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="{{ url(url(Storage::url($item->service->thumbnail_service[0]->thumbnail))) }}"
                                                alt="photo freelancer" loading="lazy" />
                                            @else
                                            <svg class="object-cover w-full h-full rounded text-gray-300"
                                                fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <td class="px-1 py-5 text-sm">
                                    ...
                                    <p class="px-4 py-2 mt-2 inline text-left text-green-500">Approved</p>
                                    ...
                                    <a href="{{ route('member.order.edit', $item->id) }}"
                                        class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">Submit</a>

                                    @elseif($item->order_status_id == '3')
                                    <a href="{{ route('member.order.show', $item->id) }}"
                                        class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">Details</a>

                                    <p class="px-4 py-2 mt-2 inline text-left text-red-500">Rejected</p>

                                    @elseif($item->order_status_id == '4')
                                    <a href="{{ route('member.accept.order', $item->id) }}"
                                    class="px-4 py-2 mt-1 mr-2 text-left text-white rounded-xl bg-serv-button">Accept</a>

                                    <a href="{{ route('member.reject.order', $item->id) }}"
                                    class="px-4 py-2 mt-1 mr-2 text-center bg-white rounded-xl">Reject</a>
